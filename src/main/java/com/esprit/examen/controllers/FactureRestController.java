...
public class FactureRestController {
    ...
    // http://localhost:8089/facture/retrieve-all-factures
    @GetMapping("/retrieve-all-factures")
    @ResponseBody
    public Set<FactureDto> getFactures() {
    	Set<FactureDto> list = factureService.retrieveAllFactures();
        return list;
    }

    // http://localhost:8089/facture/retrieve-facture/8
    ...
    @ResponseBody
    public Set<FactureDto> getFactureByFournisseur(@PathVariable("fournisseur-id") Long fournisseurId) {
